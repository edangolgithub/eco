...
class App extends Component {
  ...
  setUser = (user) => {
    ...
    this.setState({ jwt: use.idToken.jwtToken });
    global.token = use.idToken.jwtToken;
  ...
  checkapiauth(event) {
    ...
    var data = axios.get(
      "https://vhkrb2owtc.execute-api.us-east-1.amazonaws.com/dev",
      {
        headers: {
      ...
      <div className="App">
        ...
        <Router>
          <Switch>
            ...
            <Route
              path="/inventory"
              render={(props) => <Inventory {...props} auth={authProps} />}
            />
            <Route
              path="/AddInventory"
